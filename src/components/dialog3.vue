<template>
    <div id="container">
        ...
        <div id="content">
            ...
            <span id="contentText" v-html="contentText"></span>
        </div>
        <div id="footer">
...
<script>
    ...
    import contentImageUrl from '../img/image.jpg';
    export default {
        name:'dig3',
        data() {
            return {
                ...
                contentText:"<h1>TITLE</h1>content content content <b>important</b> content  <br> <br>content <br> <br> content <br> content  <br>content <br>content<br>content<br>content<br>",
